...
export default function Post() {
  ...
  const router = useRouter(); // we will use router to get the id. Ex: /edit-post/{id-of-the-post}
  ...
  // called from updatePost (allows us to upload the posts metadata to ipfs)
  ...
  async function updatePost() {
    ...
    await contract.updatePost(post.id, post.title, hash, true); //todo actually pass in a boolean variable to give user ability to publish/unpublish a post  on the ui
    router.push("/");
  }
  if (!post) return null;
